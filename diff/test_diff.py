...
SLICE = f'GY1_K035-4_C_60S_Bin2_UTC20240623_193150_-13.1C__pp_ref_cut1.fits'
...
finp(SLICE, name = 'data', xslice=1, yslice=1, clean_sci=0.75, clean_ref=0.75, blackout=True)
